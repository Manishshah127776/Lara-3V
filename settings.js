...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "OFwnjRIA#X5wGt0RyJDBCuWe2zvxg3wzdrLiHmw_fvuzKaie0opQ", // Add your session id
...
STATUS_REPLY_MSG: process.env.STATUS_REPLY_MSG || "*_`MANISH`_* 💃🏻",
